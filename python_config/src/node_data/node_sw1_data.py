...
def sw1_Structures(topology: Topology):
	...
	node_sw1=Node(
		...
		additional_config=sw1_additional_config
	)
...
def sw1_relations(topology: Topology):
	...
	sw1_node.get_interface("ethernet","0/2").connect_to(sw2_node.get_interface("ethernet","0/2"))
	sw1_node.get_interface("ethernet","0/3").connect_to(sw3_node.get_interface("ethernet","2/0"))
	sw1_node.get_interface("ethernet","1/0").connect_to(sw4_node.get_interface("ethernet","1/1"))
	sw1_node.get_interface("ethernet","3/3").connect_to(topology.get_exit_interface('exit_oob'))

def sw1_additional_config(node: Node):
	if node.hostname != 'sw1':
